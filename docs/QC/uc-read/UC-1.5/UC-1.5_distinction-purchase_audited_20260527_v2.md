...
> **Sau khi BA trả lời Q1-Q10 (v2):** Tất cả các câu hỏi đã được resolved. UC đã sẵn sàng cho test design.
...
|-------|-------------|---------|--------|
| UC-1.5 | Distinction Purchase | v2 (2026-05-27) | Final — BA Q&A resolved |

| Author / BA | Approved By | Date Created | Last Updated |
|-------------|-------------|--------------|--------------|
| Trang Nguyen (tài liệu cũ) / BA Team (tài liệu mới) | QC Lead | 2026-05-26 | 2026-05-27 |
...
**Overall State:**
UC-1.5 có 2 phiên bản tài liệu (Cũ và Mới) với logic khác nhau. Tất cả các câu hỏi đã được BA trả lời và resolved.

**Đã xác nhận với BA:**
- **Tài liệu Cũ**: Stripe payment + per-NFT purchase = logic hiện tại đang triển khai
- **Tài liệu Mới**: Activations model = logic sắp update trong tương lai
- Points: 10%+10%+10% (hiện tại) / 10%+20 points (sắp tới)
- Badge: 1 badge per account (không phụ thuộc số recipient)
- Anti-return: Frontend enforcement
- Mint: Ngay lập tức khi purchase hoàn tất

**Key Actions Required:**
1. ✅ Tất cả Q1-Q10 đã được BA resolved
2. ⚠️ Tài liệu Mới thiếu detail về cách mua activation package ban đầu (cần tách thành UC riêng)
3. ⚠️ Year 2+ discount flow chưa có detail đầy đủ

**Recommendation:**
✅ **READY** — QA có thể bắt đầu design test scenarios/cases cho cả logic Cũ (đang triển khai) và logic Mới (sắp tới). Điểm đạt 70,0/100 sau khi BA resolved Q1-Q10.
...
| **Total** | | **130** | **91/130 → 70,0/100** | ✅ **READY** (after BA Q&A resolved) |

> **Sau khi BA trả lời Q1-Q10 (v2):** Tất cả các câu hỏi đã được resolved. UC đạt điểm 70,0/100 và sẵn sàng cho test design.
